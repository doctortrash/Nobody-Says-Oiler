...
for i = 2,1000 do
  ...
  for n = 2,i do
    local newval = multiply(val,tostring(i))
    val = string.sub(newval,#newval-3,#newval)
    if #newval > 10 then
      newval = string.sub(newval,#newval-9,#newval)
    end
    val = newval
  end
  ...
  if #str > 10 then
    str = string.sub(str,#str-9,#str)
  end

end


print(string.sub(str,#str-9,#str))
